...
data = get_labels_from_json_file('/dataset/objectclasses.json')
...
def create_tf_example(group, path):
    ...
    for index, row in group.object.iterrows():
        if not math.isnan(float(row['xmin'])): #ADJUST CONDITION
...
def convert_to_tf_record(_, input_path, output_path, images_path):
