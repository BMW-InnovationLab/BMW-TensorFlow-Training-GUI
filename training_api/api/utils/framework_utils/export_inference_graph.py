...
"""
Logic to export (freeze) a model
...
trained_checkpoint_prefix: str
               prefix of the checkpoint you wish to freeze

output_directory: str
                where to store the model
"""
def export_graph(_, pipeline_config_path, trained_checkpoint_prefix, output_directory):
