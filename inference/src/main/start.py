...
error_logging = Error()
app = FastAPI(version='3.1.0', title='BMW InnovationLab tensorflow cpu inference Automation', description="<b>API for performing tensorflow cpu inference</b></br></br>"
                          																				"<b>Contact the developers:</b></br>"
                          																				"<b>Joe Sleiman: <a href='mailto:joe.sleiman@inmind.ai'>joe.sleiman@inmind.ai</a></b></br>"
